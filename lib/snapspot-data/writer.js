 ...
 */
export async function buildExport (map, mapImage, markers, photos = [], options = {}, metadataDefinitions = [], metadataValues = []) {
  // Validate inputs
  ...
  const hasMetadata = metadataDefinitions.length > 0 || metadataValues.length > 0
  const version = hasMetadata ? '1.2' : '1.1'
